  ...
  return (
    <div>
      ...
      <div className={Styles.shopmain}>
        ...
        <div className={Styles.shopone}>
          <img src={t1} onClick={() => navigate("/allproduct/Tablets")}></img>
      ...
      <div className={Styles.shopmain}>
        <div className={Styles.shopone}>
          <img src={m1} onClick={() => navigate("/allproduct/Mobile")}></img>
        ...
        <div className={Styles.shopone}>
          <img src={s} onClick={() => navigate("/allproduct/Speakers")}></img>

          {/* <p className={Styles.itemname}>Speakers</p> */}
        </div>
        <div className={Styles.shopone}>
          <img src={w} onClick={() => navigate("/allproduct/Wearable")}></img>
